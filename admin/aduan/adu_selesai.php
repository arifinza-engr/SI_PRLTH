    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
          <?php
          $no = 1;
          $sql = $koneksi->query("select a.id_pengaduan, a.nama_pengusul, a.foto, a.desa, a.status, a.nik, j.kecamatan, p.nama_desa, p.email
						from tb_usulan a join tb_kecamatan j on a.kecamatan=j.id_kecamatan
						join tb_pengusul p on a.author=p.id_desa where status='Selesai'");
