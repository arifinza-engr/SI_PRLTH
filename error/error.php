...
<head>
  ...
  <link rel="stylesheet" href="/siprlth/assets/css/error.css">
...
<body>
  <div class="container text-white" style="margin-top:150px">
    <div class="jumbotron" style="background-image: url('/siprlth/assets/img/yaya.jpg');">
      <h1 class="display-4"><?php echo $error_tittle; ?></h1>
      <p class="lead"><?php echo $error_sub; ?></p>
      <hr class="my-4">
      <p><?php echo $error_message; ?>.</p>
      <a class="btn btn-primary btn-md" href="/siprlth/index" role="button">Kembali</a>
    </div>
  </div>
