...
<body>
              ...
              <div class="card-body p-3">
                ...
                <form method="POST">
                  <div class="form-outline mb-2">
                    ...
                    <input type="text" name="nama_desa" class="form-control form-control-sm" placeholder="Masukan Nama Desa" required />
                  </div>
                  <div class="form-outline mb-2">
                    <label class="form-label">Alamat Email</label>
                    <input type="email" name="email" class="form-control form-control-sm" placeholder="Masukan Alamat Email" required />
                  </div>
                  <div class="form-outline mb-2">
                  ...
                  <div class="form-outline mb-2">
                    ...
                    <input type="text" name="alamat" class="form-control form-control-sm" placeholder="Masukan Alamat Desa" required />
                  </div>
                  <div class="form-outline mb-2">
  ...
  if (isset($_POST['Simpan'])) {
    ...
    $sql_simpan = "INSERT INTO tb_pengadu (id_desa, nama_desa, email, no_hp, alamat) VALUES (
			'$UUID',
			'" . $_POST['nama_desa'] . "',
			'" . $_POST['email'] . "',
			'" . $_POST['no_hp'] . "',
